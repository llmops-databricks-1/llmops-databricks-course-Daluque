...
# Test the function
results = search_papers("machine learning", num_results=5)
...
agent = SimpleAgent(
    ...
    system_prompt="You are a helpful assistant deep knowledge about AI and Machine Learning. Use the available tools to answer questions.",
...
response = agent.chat("What is 64 multiplied by 64?")
...
response = agent.chat("Find papers about machine learning and AI")
logger.info(f"Agent response: {response}")
