...
long_text = (
    "This is a much longer piece of text that would be used in a real application. "
) * 100
...
phrasings that would help retrieve relevant information:
...
or less, preserving key information:
