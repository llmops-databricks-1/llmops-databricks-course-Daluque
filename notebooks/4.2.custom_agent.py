...
# MAGIC     def __init__(
# MAGIC         self, llm_endpoint, system_prompt,
# MAGIC         catalog, schema, genie_space_id,
# MAGIC     ):
# MAGIC         # Automatically creates MCP tools
# MAGIC         # from Vector Search and Genie
# MAGIC         ...
# MAGIC
...
agent = ArxivAgent(
    ...
    system_prompt=(
        ...
        " Use vector search to find papers"
...
conversation_session = f"s-{timestamp}-{rand_id}"
